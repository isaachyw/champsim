...
pt = True
# big_data_dir = "/mnt/storage/isaachyw/champsim_pt/correct_new_btb_fdip_result"
big_data_dir = (
    "/mnt/storage/isaachyw/champsim_pt/pt_result"
    if pt
    else "/mnt/storage/isaachyw/champsim_pt/correct_new_btb_fdip_result"
)
...
def main():
    ...
    output_dir = Path("/mnt/storage/isaachyw/champsim_pt/hot_warm_cold_count")
