...
def main(local: bool):
    if not local:
        ...
        input_big_dir = Path("/mnt/storage/isaachyw/champsim_pt/correct_new_btb_fdip_result")
        output_dir = Path("/mnt/storage/isaachyw/champsim_pt/paper_results/ipc")
        df = generate_csv(
            input_big_dir,
            output_dir,
            key_result_name_map,
        ...
        output_dir = Path("/Users/isaachywong/Desktop/plots/paper_results/ipc")
