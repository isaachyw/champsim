...
def main():
    input_path = Path("/home/isaachywong/Desktop/UM/SURE/plots/simulation_result/pt_result_analysis/ChampSim_fdip_chubby_lru4.csv")
    ...
    # print(log_df)
    plot_bar_chart(
        output_path=Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results/l2_mpki_chubby_log.pdf"),
        df=df,
    ...
    # remove_index_suffix(df, "_result")
    # plot_bar_chart(
    #     Path("/Users/isaachywong/Desktop/plots/try.pdf"),
    #     df,
    #     r"\% Speedup over FDIP",
    #     cut_upper_bound=20,
    #     legend_col_num=4
