...
def main():
    ipc1_result_analysis_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/simulation_result/ipc1_correct_new_btb_result_analysis")
    # hwc_df = pd.read_csv(
    ...
    # ).transpose()
    # print(result_df)
    # output_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results/ipc1")
