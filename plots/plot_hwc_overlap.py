...
def compare_two_opt_access_record():
    output_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/mysql_analysis")
    output_dir.mkdir(exist_ok=True)
    raw_df_path = output_dir / "read-only_read-write.csv"
    if not raw_df_path.exists():
        read_only_path = Path("/home/isaachywong/Desktop/UM/SURE/plots/opt_access_record/way4/mysql_train_read-only.csv")
        read_write_path = Path("/home/isaachywong/Desktop/UM/SURE/plots/opt_access_record/way4/mysql_train_read-write.csv")
        # read_only_path = Path("/home/isaachywong/Desktop/UM/SURE/plots/opt_access_record/way4/mysql_train_read-only.csv")
        # read_write_path = Path("/home/isaachywong/Desktop/UM/SURE/plots/opt_access_record/way4/mysql_train_read-write.csv")
...
def plot_manually_generated_df():
    manually_generated_df = pd.read_csv(
        Path("/home/isaachywong/Desktop/UM/SURE/plots/rebuttal/hwc_overlap/all_app.csv"),
        sep=" ",
        index_col=0,
        header=0
    )
    ...
    plot_functions.plot_bar_chart(
        output_path=Path("/home/isaachywong/Desktop/UM/SURE/plots/rebuttal/hwc_overlap/all_app.pdf"),
...
def plot_mysql_overlap():
    sql_path = Path("/home/isaachywong/Desktop/UM/SURE/paper_results/rebuttal/hwc_overlap/mysql/train_largest_trace_mysql_1thread_20000tbSz_250tbNum_oltp_read_write.lua_60time.gz.csv")
    ...
    print(plot_df.mean())
    plot_functions.plot_bar_chart(
        output_path=Path("/home/isaachywong/Desktop/UM/SURE/paper_results/rebuttal/hwc_overlap/mysql/read_write.pdf"),
        df=plot_df,
        stacked=True,
        ytitle="Percentage (\%)",
        add_average=True,
    ...
    input_dir = Path("/home/isaachywong/Desktop/UM/SURE/paper_results/rebuttal/way4_8192K")
    output_dir = Path("/home/isaachywong/Desktop/UM/SURE/paper_results/rebuttal/hwc_overlap")
    output_dir.mkdir(exist_ok=True)
