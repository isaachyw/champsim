...
def main():
    ...
    df = merge_df(
        Path("/Users/isaachywong/Desktop/plots/simulation_result_ipc_summary"),
        ["4", "8", "16", "32", "64", "128"],
        name_map=name_map,
        cal_percentage=True,
    )
    ...
    print(df)
    df.to_csv("/Users/isaachywong/Desktop/plots/paper_results/way_speedup.csv")

    # TODO: Separate it into three plots, and use % of opt speedup.

    plot_functions.plot_bar_chart(
        output_path=Path(
            "/Users/isaachywong/Desktop/plots/paper_results/way_speedup.pdf"
        ),
        df=df,
