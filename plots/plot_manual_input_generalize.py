...
def generate_summary():
    output_dir = Path("/mnt/storage/isaachyw/champsim_pt/input_generalization/summary")
    ...
    for app in pt_traces:
        one_app_generate(Path("/mnt/storage/isaachyw/champsim_pt/input_generalization/simulation_output"), app,
                         output_dir)
    one_app_generate(Path("/mnt/storage/isaachyw/champsim_pt/input_generalization/simulation_output"), "mysqllarge",
                     output_dir)
...
def main():
    generate_summary()
    # parse_all_app(Path("/home/isaachywong/Desktop/UM/SURE/plots/input_generalization/summary"))
