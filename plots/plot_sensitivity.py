...
def main():
    output_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results/sensitivity")
    output_dir.mkdir(exist_ok=True)
    way_speedup_df = parse_old_csv(
        Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results/btb_way/way_speedup.csv"),
        ["cassandra", "drupal", "tomcat"]
    )
    size_speedup_df = parse_old_csv(
        Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results/btb_size/percentage_opt_ipc_speedup_size.csv"),
        ["cassandra", "drupal", "tomcat"]
    )
