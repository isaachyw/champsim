...
def main(local: bool):
    # big_input_dir = Path("/mnt/storage/isaachyw/champsim_pt/pt_result")
    big_input_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/pt_result")
    way_output_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results/btb_way")
    size_output_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results/btb_size")
    ...
    # if not local:
    #     # output_dir = Path("/mnt/storage/isaachyw/champsim_pt/paper_results/btb_size")
    #     output_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results/btb_size")
    #     output_dir.mkdir(exist_ok=True)
    #     ipc_result_df = generate_ipc_table(
    ...
    #
    #
    # output_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results/btb_way")
    # output_dir.mkdir(exist_ok=True)
    # ipc_result_df = generate_ipc_table(
    #     big_input_dir, output_dir / "ipc_result.csv", key_result_name_map,
    #     use_default_btb_record=True,
