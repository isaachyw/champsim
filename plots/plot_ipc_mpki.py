...
compare_size_name_map = {
    ...
    "7979ChampSim_fdip_lru": "LRU-7979-entry",
    ...
    "7979ChampSim_fdip_opt": "OPT-7979-entry",
}
...
src_result_name_map = {
    ...
    "ChampSim_fdip_hawkeye": "Hawkeye",
    # "ChampSim_fdip_hot_warm_cold_80_50_f_keep_curr_hotter": "Thermometer-random",
    "ChampSim_fdip_hot_warm_cold_80_50_f_keep_curr_hotter_lru": "HWC",
    # "7979ChampSim_fdip_hot_warm_cold_80_50_f_keep_curr_hotter_lru": "Thermometer-7979-entry",
    "ChampSim_fdip_opt": "OPT",
}

src_perfect_name_map = {
    "ChampSim_fdip_lru": "LRU",
...
thermometer_perfetch_name_map = {
    "ChampSim_fdip_lru": "LRU",
    "ChampSim_fdip_predecoder_btb_lru": "Confluence-LRU",
    "ChampSim_fdip_shotgun_lru": "Shotgun-LRU",
    "ChampSim_fdip_hot_warm_cold_80_50_f_keep_curr_hotter_lru": "Thermometer",
    "ChampSim_fdip_predecoder_btb_hot_warm_cold_80_50_f_keep_curr_hotter_lru": "Confluence-Thermometer",
    "ChampSim_fdip_shotgun_hot_warm_cold_80_50_f_keep_curr_hotter_lru": "Shotgun-Thermometer",
    "ChampSim_fdip_opt": "OPT",
    "ChampSim_fdip_predecoder_btb_opt": "Confluence-OPT",
    "ChampSim_fdip_shotgun_opt": "Shotgun-OPT",
    # "ChampSim_fdip_perfect_btb_champsim": "Perfect-BTB",
...
multi_level_btb_name_map = {
    "ChampSim_fdip_multi_level_btb_multi_level_lru": "LRU",
    "ChampSim_fdip_multi_level_btb_multi_level_hwc": "Thermometer",
    "ChampSim_fdip_multi_level_btb_multi_level_opt": "OPT",
}
...
def main():
    # pgo_input_dir = Path(
    #     "/home/isaachywong/Desktop/UM/SURE/plots/simulation_result/pgo_result_analysis"
    # )
    # pgo_output_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results")
    # pgo_output_dir.mkdir(exist_ok=True)
    #
    # generate_and_plot(
    #     pgo_result_name_map,
    #     "pgo_",
    ...
    # exit(0)
    input_dir = Path(
        "/home/isaachywong/Desktop/UM/SURE/plots/simulation_result/pt_result_analysis"
    )
    output_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results")
    ...
    #     figsize=(0.25, 0.9),
    #     xlabel_rotation=20,
    #     add_avg_without_verilator=False,
    # )
    # exit(0)
    generate_and_plot(
        twig_prefetch_result_name_map,
    ...
    #     figsize=(0.35, 0.9),
    #     xlabel_rotation=20,
    #     app_list=["clangbolt", "mysqllargebolt", "pgbenchbolt", "pythonbolt", "verilatorbolt"],
    #     rename_map={
    #         "clangbolt": "clang",
    #         "mysqllargebolt": "mysql",
    #         "pgbenchbolt": "pgbench",
    #         "verilatorbolt": "verilator"
    #     }
    # )
