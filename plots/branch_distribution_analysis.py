...
def main(local: bool):
    ...
    if not local:
        ...
        output_dir = Path("/mnt/storage/isaachyw/champsim_pt/branch_distribution_set/way4")
        ...
        input_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results/branch_distribution_set/way4")
        for app in app_list:
