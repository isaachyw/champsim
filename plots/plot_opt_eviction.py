...
def main(local: bool):
    # access_record_dir = Path("/mnt/storage/isaachyw/champsim_pt/opt_access_record/way4")
    access_record_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/opt_access_record/way4")
    # output_dir = Path("/Users/isaachywong/Desktop/plots/paper_results/bypass")if local else Path("/mnt/storage/isaachyw/champsim_pt/paper_results/bypass")
    output_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results/bypass")
