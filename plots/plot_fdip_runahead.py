...
def main(local: bool):
    if not local:
        ...
        output_dir = Path("/mnt/storage/isaachyw/champsim_pt/paper_results/fdip_runahead")
        ...
        output_dir = Path("/Users/isaachywong/Desktop/plots/paper_results/fdip_runahead")
