...
def main():
    big_dir = Path("/home/isaachywong/Desktop/UM/SURE/plots/paper_results")
    ...
    to_excel(Path("/home/isaachywong/Desktop/UM/SURE/plots/rebuttal/simulate_time.csv"), output_excel_file)
