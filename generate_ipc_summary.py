...
@click.option(
    "--input-dir",
    default=Path("/mnt/storage/isaachyw/champsim_pt/simulation_result"),
    type=pathlib.Path,
)
@click.option(
    "--output-dir",
    default=Path("/mnt/storage/isaachyw/champsim_pt/simulation_result_ipc_summary"),
    type=pathlib.Path,
)
...
def main(input_dir: Path, output_dir: Path, pt: bool, pt_ignore_outlier: bool):
    ...
    # base_dir = Path("/Users/isaachywong/Desktop/UM/SURE/Code/ChampSim-pt/ipc1_correct_new_btb_result_analysis/")
    mean_columns = [
        "num_ways",
        "opt",
        "srrip",
