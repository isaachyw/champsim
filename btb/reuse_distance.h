...
public:
    ...
    void print_final_stats(string &trace_name, uint64_t cpu) {
        ...
        fs::create_directory("/mnt/storage/isaachyw/champsim_pt/reuse_distance_taken");
        string filename = "/mnt/storage/isaachyw/champsim_pt/reuse_distance_taken/" + short_name + ".csv";
