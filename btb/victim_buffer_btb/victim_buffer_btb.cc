...
// Note: we only use ip_tag and target in the victim_btb, which is 128 bits in
// total. Size of victim buffer is 128-entry.
...
void O3_CPU::initialize_btb() {
  ...
  basic_btb.resize(
      NUM_CPUS, vector<vector<BASIC_BTB_ENTRY>>(
                    BASIC_BTB_SETS, vector<BASIC_BTB_ENTRY>(BASIC_BTB_WAYS)));
