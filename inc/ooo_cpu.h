...
public:
    ...
    uint64_t predicted_taken_branch_count = 0, btb_miss_taken_branch_count = 0, miss_direction=0;
...
//	initialize_btb();
        ...
        L1I.lower_level = &L2C;
//        L1I.is_perfect= (perfect_cache >>3) & 0b1;

        L1D.cpu = this->cpu;
        L1D.cache_type = IS_L1D;
        L1D.fill_level = FILL_L1;
        L1D.lower_level = &L2C;
//        L1D.is_perfect= (perfect_cache >>2) & 0b1;

        L2C.cpu = this->cpu;
        L2C.cache_type = IS_L2C;
        L2C.fill_level = FILL_L2;
//        L2C.is_perfect= (perfect_cache >>1) & 0b1;
...
//        L1D.l1d_initialize_replacement();
//        L2C.l2c_initialize_replacement();
    }
    ...
    void open_btb_record(const char *mode, bool is_shotgun) {
        string directory_name = "/mnt/storage/isaachyw/champsim_pt/";
