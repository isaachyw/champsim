...
def three_best_generalize(pt_ignore_outlier: bool, no_zero: bool):
    ...
    ignore_outlier_str = "_no_outlier" if pt_ignore_outlier else ""
    df.to_csv("/mnt/storage/isaachyw/champsim_pt/input_generalization/plots/three_best%s%s.csv"
    ...
    ignore_outlier_str = "_no_outlier" if pt_ignore_outlier else ""
    plt.savefig(
        "/mnt/storage/isaachyw/champsim_pt/input_generalization/plots/three_best%s%s.pdf"
        % (ignore_outlier_str, no_zero_str)
    )
