...
using std::endl;
using std::cerr;
extern uint8_t  dependency_level;
...
//    if(dependency_level == REGISTER_MAX_DEPENDENCY && !trace_read_instr.is_branch)
//    {
//        trace_read_instr.source_registers[0]=1;
//        trace_read_instr.destination_registers[0]=1;
//        trace_read_instr.source_registers[1]=REG_FLAGS;
//        trace_read_instr.destination_registers[1]=REG_FLAGS;
//    }
//    if(dependency_level == REGISTER_NO_DEPENDENCY && !trace_read_instr.is_branch)
//    {
//        for(auto & i : trace_read_instr.source_registers) i=0;
//        for(auto & i : trace_read_instr.destination_registers) i=0;
//    }
